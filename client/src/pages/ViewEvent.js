                    ...
                    <div className="tile">
                        ...
                        <div className="tile is-parent is-vertical">
                            ...
                            <article className="tile is-child notification ">
                                ...
                                <p className="subtitle">{chosenAttendees.length > 0 ? `Attendees(${chosenAttendees.length}):` : `Be the first attendee!`}</p>
                                {chosenAttendees.length > 0 ? <ul> {chosenAttendees.map(attendant => <li>{attendant.attendee.username}</li>)}</ul> : "" }
                            </article>
